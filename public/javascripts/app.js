...
/***/ function(module, exports, __webpack_require__) {
	...
	var _appHistory = __webpack_require__(209);
	...
	var _GravatarViewer = __webpack_require__(213);

	var _GravatarViewer2 = _interopRequireDefault(_GravatarViewer);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	(0, _reactDom.render)(_react2.default.createElement(
	  _reactRouter.Router,
	  { history: _appHistory2.default, __source: {
	      fileName: '../../../../../src/client/app.js',
	      lineNumber: 10
	    }
	  },
	  _react2.default.createElement(
	    ...
	    _react2.default.createElement(_reactRouter.Route, { path: '/:email', component: _GravatarViewer2.default, __source: {
	        fileName: '../../../../../src/client/app.js',
	        lineNumber: 12
	      }
	    })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EmailInput = __webpack_require__(212);
	...
	var App = (function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function updateEmail(email) {
	      ...
	      var pathname = history.createHref('/' + email);
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        {
	          __source: {
	            fileName: '../../../../../src/client/containers/App.js',
	            lineNumber: 15
	          }
	        },
	        _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          'Enter an email address to view their gravatar.'
	        ),
	        _react2.default.createElement(_EmailInput2.default, {
	          email: this.params.email,
	          onUpdate: function onUpdate(email) {
	            return _this2.updateEmail(email).bind(_this2);
	          }, __source: {
	            fileName: '../../../../../src/client/containers/App.js',
	            lineNumber: 18
	          }
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        { onSubmit: this.onSubmit.bind(this), __source: {
	            fileName: "../../../../../src/client/components/EmailInput.js",
	            lineNumber: 12
	          }
	        },
	        _react2.default.createElement("input", { type: "email", ref: "email", defaultValue: this.props.email, __source: {
	            fileName: "../../../../../src/client/components/EmailInput.js",
	            lineNumber: 13
	          }
	        })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _blueimpMd = __webpack_require__(214);
	...
	var GravatarViewer = (function (_React$Component) {
	  _inherits(GravatarViewer, _React$Component);

	  function GravatarViewer() {
	    _classCallCheck(this, GravatarViewer);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(GravatarViewer).apply(this, arguments));
	  }

	  _createClass(GravatarViewer, [{
	    key: 'trim',
	    ...
	    key: 'cleaned',
	    value: function cleaned(s) {
	      return this.trim(s.toLowerCase());
	    }
	  }, {
	    key: 'hashedEmail',
	    value: function hashedEmail() {
	      return (0, _blueimpMd.md5)(cleaned(this.props.email));
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      var hash = this.hashedEmail();
	      return _react2.default.createElement('img', { src: 'http://gravatar.com/avatar/' + hash, __source: {
	          fileName: '../../../../../src/client/containers/GravatarViewer.js',
	          lineNumber: 20
	        }
	      });
	    }
	  ...
	  return GravatarViewer;
	})(_react2.default.Component);

	exports.default = GravatarViewer;
